    ...
    class CustomObserver implements Observer<LinkLinkNetInfo> {
        ...
        public void onNext(LinkLinkNetInfo info) {
            ...
            if (info == null) {
                ...
                LogUtil.e("RxJava", "onNext(),线程id:" + Thread.currentThread().getId() + ",info.getData()!=null:" + (info.getData() != null));
                LogUtil.e("RxJava", "onNext(),线程id:" + Thread.currentThread().getId() + ",info.getData():" + info.getData());
                        ...
                        if (info.isSuccess()) {
                            if (info.getData() != null) {
                                try {
                                    ...
                                    LogUtil.e("RxJava", "onNext(),线程id:" + Thread.currentThread().getId() + ",info.getData().toString:" + info.getData().toString());
